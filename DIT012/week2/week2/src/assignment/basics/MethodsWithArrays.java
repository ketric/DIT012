...
public class MethodsWithArrays {
    ...
    void program() {
        ...
        System.out.println(Arrays.toString(arr));  // Use Arrays.toString() to get a nice print out

        // Comments show expected output
        System.out.println(sumArray(arr) == 30);               // true
        System.out.println(countN(arr, 4) == 2);               // true
        // Method will modify original array (= arr)
        System.out.println(Arrays.toString(setAllTo(arr, 9))); // [9, 9, 9, 9, 9, 9, 9, 9]
    }
