...
public class DiceWars {
    ...
    public static boolean hasBorder(int from, int to, int[] map) {
        ...
        {return true;}
                ...
                (ans3 == 0 || ans3 == 1 || ans3 == 5 || ans3 == 7 || ans3 == 5))
        {return true;}
        else if (ans2 == 5 &&
                (ans3 == 4 || ans3 == 2 || ans3 == 8 || ans3 == 7))
        {return true;}
        else if (ans2 == 6 &&
                (ans3 == 3 || ans3 == 7))
        {return true;}
        else if (ans2 == 7 &&
                (ans3 == 6 || ans3 == 4 || ans3 == 8))
        {return true;}
        else {return false;}
        */
    ...
    public static int[] contributeDices(int winner, int[] owners, int[] dices) {
        ...
        for (i1 = 0; (i1<9 && owners[i1] == winner); i1 ++) {
            sum1 = sum1 + dices[i1];
        }
        int totalDicesOfWinnerOrg = sum1;

        while (!done) {
            int sum2 = 0;
            for (i = 0; (i<9 && owners[i] == winner); i ++){
                dices[i] = rand.nextInt(99)+1;
            }
            for (i = 0; (i<9 && owners[i] == winner); i ++) {
                sum2 = sum2 + dices[i];
            }
            int totalDicesOfWinnerAfterSpreadOut = sum2;
            if (totalDicesOfWinnerAfterSpreadOut == totalDicesOfWinnerOrg) {break;}
            else {done = false;}
        }
